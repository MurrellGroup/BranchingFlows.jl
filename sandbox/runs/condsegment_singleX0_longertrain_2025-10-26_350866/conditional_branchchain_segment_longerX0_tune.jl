...
rundir = "runs/condsegment_singleX0_longertrain_$(Date(now()))_$(rand(100000:999999))"
...
#Finds all fist and last positions of contiguous runs of true in a mask
...
function test_sample(path; numchains = 1, chainlength_dist = [1], steps = step_sched.(0f0:0.005:1f0), only_sampled_masked = true)
...
uncond_model = Flux.loadmodel!(BranchChainV1(), JLD2.load("/home/murrellb/ProtModels/BranchingFlows.jl/sandbox/maxisplitty_536734_epoch_3.jld", "model_state"));
